...
class BetweenChapters {
    ...
    initFcTable = () => {
      this.table = [
        ...
        [ this.launchMusic("assets/sound/vraieville_NorthKorea.mp3"), this.launchVoiceOver(2), this.launchVoiceOver(3), this.launchText(1), this.launchConclusion(1), this.stopConclusion ],
