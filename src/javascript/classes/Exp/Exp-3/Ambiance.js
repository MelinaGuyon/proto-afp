class Ambiance {
    ...
    createLight() {
      this.light1 = new THREE.PointLight(0xbc7820, 0.40, 0, 2)
      ...
      Storage.SceneClasses.exp3.scene.add(this.light1)
      ...
      Storage.SceneClasses.exp3.scene.add(this.light2)

      this.light3 = new THREE.PointLight(0xbc7820, 0.25, 0, 2)
      ...
      Storage.SceneClasses.exp3.scene.add(this.light3)

      this.lightAmb = new THREE.AmbientLight(0xffffff, 0.20)
      Storage.SceneClasses.exp3.scene.add(this.lightAmb)
      ...
      Storage.SceneClasses.exp3.scene.add( this.spotLight1 );

      this.spotLight2 = new THREE.SpotLight( 0xbc7820, 0, 1000, 0.5, 0.9 );
      this.spotLight2.position.set( -180, 600, -250 );
      this.spotLight2.rotation.y = - Math.PI / 5
      Storage.SceneClasses.exp3.scene.add( this.spotLight2 );
    }
      ...
      this.vertex_loader.load('glsl/BackgroundVertex.vert', function (vertexGround) {
        that.fragment_loader.load('glsl/BackgroundFragment.frag', function (fragmentGround) {
          ...
          that.backgroundUniforms = THREE.UniformsUtils.merge([
            ...
            { emissive: { value: new THREE.Color(0xbc7820) } },
            { shininess : { value: 5 } },
            { hue : { value: 1 } },
            { u_time: { type: "f", value: 1.0 } },
            { u_resolution: { type: "v2", value: new THREE.Vector2(1024, 768) } },
            { u_mouse: { type: "v2", value: new THREE.Vector2() } },
            { u_color1: { value: new THREE.Color(0xf4a742) } },
          ...
          Storage.backgroundExp3 = cube
          Storage.SceneClasses.exp3.scene.add(cube)
        })
      })
    }
    ...
    createFakeShadow() {
      ...
      Storage.SceneClasses.exp3.scene.add( fakeShadow )
    }
